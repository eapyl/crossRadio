@echo off
set CAKE_VERSION=0.30.0
mkdir tools
@echo ^<Project Sdk="Microsoft.NET.Sdk"^>^<PropertyGroup^>^<OutputType^>Exe^</OutputType^>^<TargetFramework^>netcoreapp2.1^</TargetFramework^>^</PropertyGroup^>^</Project^> > tools\tools.csproj
